...
system('cls');
system('Admin Panel Bulucu blinkcursor.org');
 
print"\n";
print "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n" ;
print "                            Admin Panel Bulucu  \n" ;
print "                                Türkçe Sürüm     \n " ;
print "                        Website :www.blinkcursor.org\n\n" ;
print "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n" ;
print "\n";
 
print " Hedef Website: \n";
print" örnek: www.site.com \n";
print" --> ";
$site=<STDIN>;
chomp $site;
...
print "\n\n";
print " Site Dili: \n";
print" örnek: asp, php, cfm, any\n";
print" bilmiyorsanız bunu yazın : ** any ** \n";
print"--> ";
$code=<STDIN>;
chomp($code);
...
print "-> website: $site\n";
print "->web site kaynağı: $code\n";
print "->panel aranıyor...\n\n\n";
...
print " \n [+] bulundu -> $final\n\n";
print " \n tebrikler panel bulundu \n\n ";
}else{
print "[-] bulunamdı<- $final\n";
}
}
}
